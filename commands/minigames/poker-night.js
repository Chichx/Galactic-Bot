...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
            ...
            .then(res => res.json())
            .then(invite => {
                if (invite.error || !invite.code) return message.channel.send("❌ | No se pudo iniciar **Poker Night**!");
                message.channel.send(`✅ | Haga clic aquí para iniciar **Poker Night** en ${channel.name}: <https://discord.gg/${invite.code}>`);
            })
            .catch(e => {
                message.channel.send("❌ | No se pudo iniciar **Poker Night**!");
            })
    }
}